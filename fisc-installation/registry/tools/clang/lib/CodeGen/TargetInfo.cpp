...
//===----------------------------------------------------------------------===//
// FISC ABI Implementation
//===----------------------------------------------------------------------===//
namespace {
class FISCABIInfo : public DefaultABIInfo {
public:
  FISCABIInfo(CodeGen::CodeGenTypes &CGT) : DefaultABIInfo(CGT) {}
};

class FISCTargetCodeGenInfo : public TargetCodeGenInfo {
public:
  FISCTargetCodeGenInfo(CodeGenTypes &CGT)
      : TargetCodeGenInfo(new FISCABIInfo(CGT)) {}
};
} // End anonymous namespace.
...
const TargetCodeGenInfo &CodeGenModule::getTargetCodeGenInfo() {
  ...
  case llvm::Triple::fisc:
    return *(TheTargetCodeGenInfo = new FISCTargetCodeGenInfo(Types));
