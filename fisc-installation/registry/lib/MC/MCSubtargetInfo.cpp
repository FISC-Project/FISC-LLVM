...
bool FiscDisableUnrecognizedMessage = false;
...
void MCSubtargetInfo::InitMCProcessorInfo(StringRef CPU, StringRef FS) {
  #if 1 // Disable recognized processor message. For FISC
  if (TargetTriple.getArch() == llvm::Triple::fisc)
    FiscDisableUnrecognizedMessage = true;
  #endif
