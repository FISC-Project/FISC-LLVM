...
FISCInstrInfo::FISCInstrInfo()
  : FISCGenInstrInfo(FISC::ADJCALLSTACKDOWN, FISC::ADJCALLSTACKUP),
    RI() {}
...
bool FISCInstrInfo::expandPostRAPseudo(MachineBasicBlock::iterator MI) const {
  ...
  case FISC::MOVi32: {
    ...
    auto LO16 = BuildMI(MBB, MI, DL, get(FISC::MOVLOi16), DstReg);
    auto HI16 = BuildMI(MBB, MI, DL, get(FISC::MOVHIi16))
    ...
    if (MO.isImm()) {
      ...
      LO16 = LO16.addGlobalAddress(GV, MO.getOffset(), TF | FISCII::MO_LO16);
      HI16 = HI16.addGlobalAddress(GV, MO.getOffset(), TF | FISCII::MO_HI16);
    }
