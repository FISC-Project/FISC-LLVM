...
// FISC Specific e_flags
enum {
  EF_FISC_NOREORDER = 0x00000001, // Don't reorder instructions
  EF_FISC_PIC       = 0x00000002, // Position independent code
  EF_FISC_ARCH_64   = 0x50000000, // FISC instruction set per linux not elf.h
  EF_FISC_ARCH      = 0xf0000000  // Mask for applying EF_FISC_ARCH_ variant
};
